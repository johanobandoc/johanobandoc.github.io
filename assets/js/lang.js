(function () {
  var T = {
    en: {
      ...
      'about.bio2': 'I spent three years as a Student Researcher at <a href="https://research.google.com/teams/brain/" rel="external nofollow noopener" target="_blank">Google Brain</a> and <a href="https://deepmind.google/" rel="external nofollow noopener" target="_blank">DeepMind</a> working on deep RL. I hold an M.Sc. in Machine Learning from <a href="https://diro.umontreal.ca/english/home/" rel="external nofollow noopener" target="_blank">Université de Montréal</a> (co-supervised by <a href="https://scholar.google.com/citations?hl=en&amp;user=uyYPun0AAAAJ&amp;view_op=list_works&amp;sortby=pubdate" rel="external nofollow noopener" target="_blank">Marc Bellemare</a>), and an M.Sc. in Engineering Science and a B.Sc. in Mechatronics Engineering from <a href="https://www.uao.edu.co/" rel="external nofollow noopener" target="_blank">Universidad Autónoma de Occidente</a>.',
    ...
    es: {
      ...
      'about.bio2': 'Trabajé tres años como Investigador Estudiantil en <a href="https://research.google.com/teams/brain/" rel="external nofollow noopener" target="_blank">Google Brain</a> y <a href="https://deepmind.google/" rel="external nofollow noopener" target="_blank">DeepMind</a> trabajando en RL profundo. Tengo una M.Sc. en Aprendizaje Automático de la <a href="https://diro.umontreal.ca/english/home/" rel="external nofollow noopener" target="_blank">Université de Montréal</a> (co-supervisado por <a href="https://scholar.google.com/citations?hl=en&amp;user=uyYPun0AAAAJ&amp;view_op=list_works&amp;sortby=pubdate" rel="external nofollow noopener" target="_blank">Marc Bellemare</a>), y una M.Sc. en Ciencias de la Ingeniería y una B.Sc. en Ingeniería Mecatrónica de la <a href="https://www.uao.edu.co/" rel="external nofollow noopener" target="_blank">Universidad Autónoma de Occidente</a>.',
