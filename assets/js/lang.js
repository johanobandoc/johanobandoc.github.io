(function () {
  var T = {
    en: {
      ...
      'about.bio2': 'Previously, I spent three years as a Student Researcher at <a href="https://research.google.com/teams/brain/" rel="external nofollow noopener" target="_blank">Google Brain</a> and <a href="https://deepmind.google/" rel="external nofollow noopener" target="_blank">DeepMind</a>, conducting research in deep reinforcement learning. I hold a Master\'s degree in Machine Learning from <a href="https://diro.umontreal.ca/english/home/" rel="external nofollow noopener" target="_blank">Université de Montréal</a>, and a Master\'s degree in Engineering Science and Robotics and a Bachelor\'s degree in Mechatronics Engineering from <a href="https://www.uao.edu.co/" rel="external nofollow noopener" target="_blank">Universidad Autónoma de Occidente</a>.',
    ...
    es: {
      ...
      'about.bio2': 'Anteriormente, trabajé durante tres años como Investigador Estudiantil en <a href="https://research.google.com/teams/brain/" rel="external nofollow noopener" target="_blank">Google Brain</a> y <a href="https://deepmind.google/" rel="external nofollow noopener" target="_blank">DeepMind</a>, realizando investigación en aprendizaje por refuerzo profundo. Tengo una Maestría en Aprendizaje Automático de la <a href="https://diro.umontreal.ca/english/home/" rel="external nofollow noopener" target="_blank">Université de Montréal</a>, y una Maestría en Ciencias de la Ingeniería y Robótica y un título de Ingeniería Mecatrónica de la <a href="https://www.uao.edu.co/" rel="external nofollow noopener" target="_blank">Universidad Autónoma de Occidente</a>.',
